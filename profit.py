...
capital = input(f"{Fore.LIGHTMAGENTA_EX} Initial {Fore.LIGHTGREEN_EX}Capital?") #initial capital 
yes_no_contract = input(f'{Fore.LIGHTMAGENTA_EX}Purchased {Fore.LIGHTGREEN_EX}"Yes" {Fore.LIGHTMAGENTA_EX} or {Fore.LIGHTRED_EX}"No" {Fore.LIGHTGREEN_EX}Contract?') #Purchased "Yes" or "No" Contract
